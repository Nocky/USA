...
import com.linkloving.rtring_c_watch.widget.ScrollOverListView.OnScrollOverListener;
...
public class PaginationView extends LinearLayout implements OnScrollOverListener
{
		...
		mFooterView.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v)
			{
				if (!mIsFetchMoreing && !mIsNoMoreData)
				{
					...
					mFooterTextView.setText(R.string.general_loading);
					mFooterLoadingView.setVisibility(View.VISIBLE);
		...
		public void handleMessage(Message msg)
		{
			switch (msg.what)
			{
				...
				case WHAT_DID_MORE:
				{
					...
					mFooterTextView.setText(mIsNoMoreData ? R.string.general_no_more_data : R.string.general_more);
					mFooterLoadingView.setVisibility(View.GONE);
				}
			}
		}
