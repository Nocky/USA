...
//		db.execSQL(SckhTable.DB_CREATE);
	}
	 ...
	 * {@inheritDoc}
	 */
	public static void dropAllTables(SQLiteDatabase db, int oldVersion,
			int newVersion)
	{
...
//		db.execSQL("DROP TABLE IF EXISTS " + SckhTable.TABLE_NAME);
	}
	...
	private static class DatabaseHelper extends SQLiteOpenHelper
	{
		...
		public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion)
		{
			...
			// DROP TABLE
			dropAllTables(db, oldVersion, newVersion);
			//
			onCreate(db);
		}
	}
